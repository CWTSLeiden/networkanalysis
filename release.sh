...
printf "\nPackaging jar file\n"
printf "================================================\n"
jar cvfe dist/RunNetworkClustering-$VERSION.jar cwts.networkanalysis.run.RunNetworkClustering -C build/jar .

printf "\nPackaging source code\n"
printf "================================================\n"
find src -type f -iname "*.java" -print0 | tar -czvf dist/RunNetworkClustering-$VERSION-source.tar.gz --null -T -
